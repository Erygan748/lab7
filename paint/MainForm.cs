...
namespace paint
{
    public partial class MainForm : Form
    {
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e) // открывает файл 
        {
            ...
            for (int i = 0; i < MdiChildren.Length; ++i)
            {
                ...
                {
                    // проверка на открытый файл с такимже именем
            ...
            if (dialogResult == DialogResult.OK)
            {
                ...
                {
                    // Откроет файл и начнет сохранять в массив то, что я отрисую дальше
                    Array = array,
        ...
        {
            /*сохранять в файл, который уже сохранен*/
        ...
        {
            /*если выбран цвет, то сохраняет его как основной*/
        ...
        {
            /*длина линии и вызовет форму LineSizeForm*/
