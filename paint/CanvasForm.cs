...
namespace paint
{
    ...
    public partial class CanvasForm : Form
    {
        ...
        public CanvasForm(Size size) // переменная размером нашего окна и минимальный размер скролинга этого окна
        {
            InitializeComponent();
        ...
        private void CanvasForm_Load(object sender, EventArgs e)
        {
            ...
            buffer = contex.Allocate(CreateGraphics(), new System.Drawing.Rectangle(0, 0, workPlaceSize.Width, workPlaceSize.Height)); // буферизация contex задаётся окну, рабочей области по длине и ширине

            System.Drawing.Point startPoint = new System.Drawing.Point(0, 0);
            System.Drawing.Rectangle rectangle = new System.Drawing.Rectangle(startPoint, workPlaceSize); // рабочее окно
            System.Drawing.SolidBrush solidBrush = new System.Drawing.SolidBrush(System.Drawing.Color.White); // заливка фона + переносит рабочую область то, что делали в 6

            buffer.Graphics.FillRectangle(solidBrush, rectangle); // для уменьшения мерцания
